...
from admins.views import UserListView, index, UserCreateView, UserUpdateView, UserDeleteView, CategoryListView, CategoryCreateView, CategoryUpdateView, CategoryDeleteView
